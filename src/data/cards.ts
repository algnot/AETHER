...
const CARD_DRAFTS: CardDraft[] = [
  ...
  },
  {
    ...
    description:
      "สั่งใช้ได้เมื่อมี「คาถา」ในสุสานอย่างน้อย 3 ใบ — เทิร์นละครั้ง: การ์ดใบนี้ ATK + ตามจำนวน「คาถา」ในสุสาน (สะสมถาวรจนกว่าออกจากสนาม · ถ้ามี「คาถา」ในสุสานอย่างน้อย 5 ใบ ใช้ความสามารถนี้ได้ 2 ครั้งต่อเทิร์น)\nเทิร์นละครั้ง: เมื่อเราเปิดใช้เวทย์/กับดักที่มีชื่อ「คาถา」 เลือกมอนสเตอร์ฝ่ายตรงข้าม 1 ตัว — ATK −1 × จำนวน「คาถา」ในสุสานเรา (เหลือ 0 ถูกทำลาย)",
  },
];
