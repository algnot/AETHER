...
const CARD_DRAFTS: CardDraft[] = [
  ...
  // —— Box S01 ——
  {
    ...
    description:
      "เทิร์นละครั้ง: นำเวทย์มนต์หรือกับดักที่มีชื่อ «คาถา» จากเด็คหรือสุสานขึ้นมือ — ค่าร่ายของการ์ดใบนั้นเป็น 0 จนจบเทิร์น\nเมื่อเราเปิดใช้เวทย์มนต์หรือกับดักที่มีชื่อ «คาถา» การ์ดใบนี้ ATK +2",
  },
  {
    id: "S0102",
  ...
  },
  {
    ...
    description:
      "คาถา — เลือกมอนสเตอร์จอมเวทย์บนสนามเรา 1 ใบ จนจบเทิร์นของอีกฝ่าย การ์ดใบนั้นไม่สามารถถูกนำออกจากสนามได้ทุกกรณี",
  },
  {
    id: "S0111",
  ...
  },
  {
    ...
    description:
      "คาถา — เลือกมอนสเตอร์จอมเวทย์บนสนามเราสูงสุด 2 ตัว นำพลังโจมตีของทั้งสองมาบวกกัน แล้วเปลี่ยนพลังโจมตีของมอนสเตอร์ทั้งสองให้เท่ากับผลรวมนั้น",
  },
  {
    id: "S0113",
    ...
    description:
      "ตราบใดที่การ์ดใบนี้อยู่บนสนาม ค่าร่ายของเวทย์/กับดักที่มีชื่อ «คาถา» ของเราลดลง 2\nเมื่อเราเปิดใช้เวทย์/กับดักที่มีชื่อ «คาถา» ได้รับพลังงาน +1",
  },
  {
    id: "S0114",
